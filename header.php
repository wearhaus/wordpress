...
<html <?php language_attributes(); ?> class="no-js">
	<head>
        ...
        fbq('init', '240641422936912');
        fbq('track', "PageView");</script>
        <noscript><img height="1" width="1" style="display:none"
        src="https://www.facebook.com/tr?id=240641422936912&ev=PageView&noscript=1"
        /></noscript>
    				        ...
    				        <div class="col-md-8" >
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    <a class="navbar-brand logo-hidden" id ="blognavbar-logo" href="<?php bloginfo('url');?>">
                                        <img src="<?php bloginfo('stylesheet_directory'); ?>/img/logo_black_transparent.png" alt="brand"/>
                                    </a>
