...
<aside class="sidebar" role="complementary">
	<div class="col-md-3 sidebar_p1" >
		...
		<div class="sidebar_body" id="tw_sb_body">
            <a class="twitter-timeline" href="https://twitter.com/wearhausinc" data-widget-id="662062697186390016">Tweets by @wearhausinc</a>
		...
		<div class="sidebar_body" id="ig_sb_body">
			<div class="sidebar-widget">
				<?php echo do_shortcode('[instagram-feed height=350]'); ?>
			</div>
		</div>   
